...
urlpatterns = [
    ...
    path('comment/create/question/<int:question_id>/', comment_view.comment_create_question,
         name='comment_create_question'),

    # 질문에 대한 댓글 수정. comment_id를 받아 해당 댓글을 수정하는 comment_view.comment_modify_question 함수 호출.
    path('comment/modify/question/<int:comment_id>/', comment_view.comment_modify_question,
         name='comment_modify_question'),

    # 질문에 대한 댓글 삭제. comment_id를 받아 해당 댓글을 삭제하는 comment_view.comment_delete_question 함수 호출.
    path('comment/delete/question/<int:comment_id>/', comment_view.comment_delete_question,
